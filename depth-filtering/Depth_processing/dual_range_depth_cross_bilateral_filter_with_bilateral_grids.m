function [output, mask_undefined] =...
    dual_range_depth_cross_bilateral_filter_with_bilateral_grids(input_image,...
...
dc1 = round((color_1 - intensity_min(1)) / sampling_intensity) +...
    padding_intensity + 1;
dc2 = round((color_2 - intensity_min(1)) / sampling_intensity) +...
    padding_intensity + 1;
dc3 = round((color_3 - intensity_min(1)) / sampling_intensity) +...
    padding_intensity + 1;
...
% Even though |label_kernel| has two dimensions, MATLABs |convn| is able to
...
dc1 = (color_1 - intensity_min(1)) / sampling_intensity +...
    padding_intensity + 1;
dc2 = (color_2 - intensity_min(1)) / sampling_intensity +...
    padding_intensity + 1;
dc3 = (color_3 - intensity_min(1)) / sampling_intensity +...
    padding_intensity + 1;
