...
def light_classes():
    return [
        'unlabeled', 'window_building', 'window_parked', 'window_transport', 
        'traffic_light', 'street_light', 'parked_front', 'parked_rear', 
        'moving_front', 'moving_rear', 'advertisement', 'clock', 'inferred'
    ]
...
def light_palette():
    return [
        ...
        [190, 153, 153], [153, 153, 153], [250, 170, 30], [220, 220, 0],
        [107, 142, 35], [152, 251, 152], [70, 130, 180], [220, 20, 60], [0, 0, 25]
    ]
